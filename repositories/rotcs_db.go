...
func (r *rotcsRepoDB) GetRotcsExtend(std_code string) (*RotcsExtendRepo, error) {
	...
	CASE
	WHEN option1 = "1" THEN "สำเนา สด.๙ ๒ ฉบับ : มี" ELSE "สำเนา สด.๙ ๒ ฉบับ : ไม่มี"
	END option1,
	CASE 
	WHEN option1 = "1" THEN "สำเนา สด.๙ ๒ ฉบับ : มี" ELSE "สำเนา สด.๙ ๒ ฉบับ : ไม่มี" 
	END option1,
	CASE 
	WHEN option2 = "1" THEN "สำเนาทะเบียนบ้าน ๒ ฉบับ : มี" ELSE "สำเนาทะเบียนบ้าน ๒ ฉบับ : ไม่มี" 
	END option2,
	CASE 
	WHEN option3 = "1" THEN "สำเนาหมายเรียก(สด.๓๕) ๒ ฉบับ : มี" ELSE "สำเนาหมายเรียก(สด.๓๕) ๒ ฉบับ : ไม่มี" 
	END option3,
	CASE 
	WHEN option4 = "1" THEN "สำเนาบัตรนักศึกษา ๒ ฉบับ : มี" ELSE "สำเนาบัตรนักศึกษา ๒ ฉบับ : ไม่มี" 
	END option4,
	CASE 
	WHEN option5 = "1" THEN "ใบรับรองผลการศึกษา ๙ หน่วยกิต ๒ ฉบับ : มี" ELSE "ใบรับรองผลการศึกษา ๙ หน่วยกิต ๒ ฉบับ : ไม่มี" 
	END option5,
	CASE 
	WHEN option6 = "1" THEN "หนังสือรับรองการเป็นนักศึกษา ๒ ฉบับ : มี" ELSE "หนังสือรับรองการเป็นนักศึกษา ๒ ฉบับ : ไม่มี" 
	END option6,
	CASE 
	WHEN option7 = "1" THEN "สำเนาบัตรประชาชน ๒ ฉบับ : มี" ELSE "สำเนาบัตรประชาชน ๒ ฉบับ : ไม่มี" 
	END option7,
	CASE 
	WHEN option8 = "1" THEN "ใบเสร็จลงทะเบียนเรียนภาคปัจจุบัน ๒ ฉบับ : มี" ELSE "ใบเสร็จลงทะเบียนเรียนภาคปัจจุบัน ๒ ฉบับ : ไม่มี" 
	END option8,
	CASE 
