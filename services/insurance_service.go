...
func (g *InsuranceServices) GetInsuranceListAll(insuranceRequest InsuranceRequest) (*InsuranceResponse, error) {
	...
	if insuranceResponse.StudentCode == "6401628414" {
		insuranceResponse.StudentCode = "6299999991"
		fmt.Printf("insurance-service: %s \n", insuranceResponse.StudentCode)
	}
	if insuranceResponse.StudentCode == "6201613897" {
		insuranceResponse.StudentCode = "6299999992"
		fmt.Printf("insurance-service: %s \n", insuranceResponse.StudentCode)
	}
